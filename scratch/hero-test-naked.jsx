 ...
 * This component uses window.Lucide icons and typical IA artifacts.
 */
const HeroTest = () => {
    return (
            ...
            <div className="container mx-auto px-6 z-10">
                <div className="flex flex-col items-center text-center">
                    <div className="mb-6 p-3 bg-blue-500/20 rounded-full">
                        <window.Lucide.Zap className="w-8 h-8 text-blue-400" />
                    </div>
                    ...
                    <div className="flex gap-4">
                        <button className="px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-semibold transition-all flex items-center gap-2">
                            Começar Agora
                            <window.Lucide.ArrowRight className="w-4 h-4" />
                        </button>
